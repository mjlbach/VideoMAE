...
MODEL_PATH='/viscam/u/mjlbach/video_memory_project/ego4d_90_2000_macondo/checkpoint-359.pth'
...
do
    ...
    OUTPUT_DIR="/viscam/u/mjlbach/video_memory_project/ego4d_90_2000_macondo/$directory"
