...
MODEL_PATH='/viscam/u/mjlbach/video_memory_project/ego4d_10_mini/checkpoint-800.pth'
...
do
    ...
    OUTPUT_DIR="/viscam/u/mjlbach/video_memory_project/ego4d_10_mini/$directory"
